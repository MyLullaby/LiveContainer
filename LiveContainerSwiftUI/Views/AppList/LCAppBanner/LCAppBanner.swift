...
struct LCAppBanner: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UIViewController {
        let viewController = LCAppBannerViewController(delegate: delegate, config: LCAppBannerConfiguration(model: model, dynamicColors: dynamicColors, iconStyle: iconStyle))
